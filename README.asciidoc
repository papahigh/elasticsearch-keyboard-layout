...
NOTE: Please note that due to the https://github.com/elastic/elasticsearch/pull/30284[serialization issue] this plugin is available only for Elasticsearch 7.0.0 and above.
...
$ bin/elasticsearch-plugin install https://github.com/papahigh/elasticsearch-russian-keyboard-switcher/raw/7.0.0/plugin-distributions/russian-keyboard-layout-7.0.0.zip
----
