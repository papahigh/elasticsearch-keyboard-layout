...
E.g., command for Elasticsearch 7.0.1

[source,sh,options="wrap"]
----
# install plugin on Elasticsearch 7.0.1
$ bin/elasticsearch-plugin install https://github.com/papahigh/elasticsearch-keyboard-layout/raw/7.1.0/dist/keyboard-layout-7.1.0.zip
----
