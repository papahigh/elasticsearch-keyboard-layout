...
This plugin may be used in combination with {url-phonetic-plugin}[Russian phonetic analysis] in order to build a google-like search experience known as "did you mean?" for russian users.
